import svgPaths from "./svg-rom6zhuvkt";

function Info() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Info">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_34_4249)" id="Info">
          <path d={svgPaths.p3b51300} id="Vector" stroke="var(--stroke-0, #059669)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
        <defs>
...
function Info1() {
  return (
    <div className="bg-[rgba(163,163,163,0.14)] box-border content-stretch flex gap-[4px] items-center px-[16px] py-[8px] relative rounded-[999px] shrink-0" data-name="Info">
      <Info />
      <p className="font-['Pretendard_Variable:Medium',_sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-center text-emerald-600 text-nowrap tracking-[-0.28px] whitespace-pre">{` 여러 약을 한번에 추가할 수 있어요!`}</p>
    </div>
  );
}
...
function BtnTit() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="btn_tit">
      <div className="flex flex-col font-['Pretendard:Medium',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-emerald-700 text-nowrap tracking-[-0.32px]">
...
function Buttons() {
  return (
    <div className="basis-0 bg-emerald-100 grow h-[48px] min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Buttons">
